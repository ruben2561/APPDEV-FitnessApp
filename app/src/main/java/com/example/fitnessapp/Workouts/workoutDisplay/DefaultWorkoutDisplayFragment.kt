...
class DefaultWorkoutDisplayFragment(exercisesIds: String, private val workoutTitle: String) : Fragment(){
    ...
    override fun onCreateView(
        ...
        binding.rvExercises.adapter = DefaultWorkoutDisplayAdapter(exercises)                                                  // adds the exercises list in the recyclerview
